...
import pt.isel.ls.Model.Commands.StudentManagement.GetCoursesAcrClassesSemNumStudents;
...
public class GetCoursesAcrClassesSemNumStudentsTest extends StudentManagement {
    @Test
    public void normalConditionTest() {
        ...
        try {
             ...
             */
            Command c = new GetCoursesAcrClassesSemNumStudents();
