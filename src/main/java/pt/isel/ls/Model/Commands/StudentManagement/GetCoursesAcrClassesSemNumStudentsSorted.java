...
public class GetCoursesAcrClassesSemNumStudentsSorted implements Command {
    private CustomMap<String, String> semesterTime = new CustomMap<>();
    private String acr, sem, num;
    private Integer year, skip, top;
    private static final Logger _logger = LoggerFactory.getLogger(GetCoursesAcrClassesSemNumStudentsSorted.class);

    public GetCoursesAcrClassesSemNumStudentsSorted() {
    }

    public GetCoursesAcrClassesSemNumStudentsSorted(String description, String template) {
    ...
    @Override
    /**
     * Perform the sorted select of all students from the given class if possible.
     */
    public Result execute(CustomMap<String, String> pathParameters, CustomMap<String, CustomList<String>> parameters, Connection conn) throws SQLException, NotExistInformationException, ParametersException, InvalidTypeException {
        ...
        _logger.info("Beginning to execute the command GET /courses/{}/classes/{}/{}/students/sorted", acr, sem, num);
        ...
        _logger.info("End of execution the command GET /courses/{}/classes/{}/{}/students/sorted", acr, sem, num);
    ...
    private void validateParameters(CustomMap<String, CustomList<String>> parameters) throws ParametersException, InvalidTypeException {
        ...
        if (parameters != null) {
            ...
            if (skipAux == null && topAux == null || parameters.size() > 2)
